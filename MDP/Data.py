...
class Data:
    ...
    a more valid assumption on a model like GMM as opposed to k-means). The expect minimum 
    ...
    cluster i given only F(p) and \sum_{i} Pr(c_i) min_j Sep_p(i,j) as the score of p.
    '''
